		...
		If OpenClanPage() Then
			If Go2Bottom() Then
				...
				For $Rank = 0 To 9
					...
					If QuickMIS("BC1", $g_sImgKickOut, 460, 45, 575, 642, $Screencap, $Debug) Then
						; Click KickOut
...
Func OpenClanPage()
	...
	Local $iCount = 0
	While Not QuickMIS("BC1", $g_sImgClanProfilePage, 110, 23, 250, 56, True, False)
	...
	$g_iTroopsDonated = getProfile(159, 302) ; MAY UPDATE
...
Func Go2Bottom()
	...
	; Clan Edit Button
	Local $CheckEditButton[4] = [500, 336, 0xd5f17d, 5]
...
Func GetMemberRank($Slot = 0)
	...
	Local $iSlot = 52
	Local $x = 25, $y = 527, $x1 = 60, $y1 = $y + 52
	Local $Return[3] = [0, 0, 0]
	Local $iClanPosition = ""

	Local $YSlot = ($y - ($Slot * 52)) + 22
