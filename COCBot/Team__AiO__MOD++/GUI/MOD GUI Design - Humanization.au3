...
Func TabHumanizationGUI()
	...
	$g_ahumanMessage[0] = GUICtrlCreateInput(GetTranslatedFileIni("MOD GUI Design - BotHumanization", "HumanMessage_01", "Hello !"), $x + 65, $y + 25, 121, 21)
	...
	$g_ahumanMessage[1] = GUICtrlCreateInput(GetTranslatedFileIni("MOD GUI Design - BotHumanization", "HumanMessage_02", "Re !"), $x + 215, $y + 25, 116, 21)
		GUICtrlSetBkColor(-1, 0xD1DFE7)
	...
	$g_hChallengeMessage = GUICtrlCreateInput(GetTranslatedFileIni("MOD GUI Design - BotHumanization", "ChallengeMessage", "Ready to Challenge?"), $x + 215, $y + 50, 116, 21)
		GUICtrlSetBkColor(-1, 0xD1DFE7)
