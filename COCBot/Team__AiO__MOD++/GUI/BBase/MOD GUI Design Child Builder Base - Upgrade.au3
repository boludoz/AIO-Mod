...
Global $g_hChkBBSuggestedUpgradesIgnoreWall = 0

Global $g_hbtnBBAttack
Func CreateUpgradeBuilderBaseSubTab()
	...
	Static $sTxtSLNames = GetTranslatedFileIni("MBR Global GUI Design", "Any", "Any") & "|" & _
	...
	If $g_bDevMode Then
		...
		$g_hbtnBBAttack = GUICtrlCreateButton("Debug UI", $x + 120, $y + 130, 85, 25)
