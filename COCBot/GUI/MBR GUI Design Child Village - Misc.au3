...
Func CreateBBDropOrderGUI()
	...
	GUICtrlCreateGroup("Army", 16, 8, 393, 110)
	
	$g_hChkBBCustomArmyEnable = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "BBChkCustomArmyEnable", "Enable Custom Army"), 16 + 10, 20, 150, 17)
		GUICtrlSetState(-1, $GUI_UNCHECKED)
		GUICtrlSetOnEvent(-1, "chkBBCustomArmy")

	$g_hIcnTroopBB[0] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnBlank, 32, 32 + 5, 41, 41)
	$g_hIcnTroopBB[1] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnBlank, 96, 32 + 5, 41, 41)
	$g_hIcnTroopBB[2] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnBlank, 160, 32 + 5, 41, 41)
	$g_hIcnTroopBB[3] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnBlank, 224, 32 + 5, 41, 41)
	$g_hIcnTroopBB[4] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnBlank, 288, 32 + 5, 41, 41)
	$g_hIcnTroopBB[5] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnBlank, 352, 32 + 5, 41, 41)
	
	$g_hComboTroopBB[0] = GUICtrlCreateCombo("", 24, 80, 57 + 5, 25, BitOR($CBS_DROPDOWN,$CBS_AUTOHSCROLL))
		GUICtrlSetOnEvent(-1, "GUIBBCustomArmy")
		GUICtrlSetData(-1,  $g_sBBDropOrderDefault)
		GUICtrlSetState(-1, $GUI_DISABLE)
	$g_hComboTroopBB[1] = GUICtrlCreateCombo("", 88, 80, 57 + 5, 25, BitOR($CBS_DROPDOWN,$CBS_AUTOHSCROLL))
		GUICtrlSetOnEvent(-1, "GUIBBCustomArmy")
		GUICtrlSetData(-1,  $g_sBBDropOrderDefault)
		GUICtrlSetState(-1, $GUI_DISABLE)
	$g_hComboTroopBB[2] = GUICtrlCreateCombo("", 152, 80, 57 + 5, 25, BitOR($CBS_DROPDOWN,$CBS_AUTOHSCROLL))
		GUICtrlSetOnEvent(-1, "GUIBBCustomArmy")
		GUICtrlSetData(-1,  $g_sBBDropOrderDefault)
		GUICtrlSetState(-1, $GUI_DISABLE)
	$g_hComboTroopBB[3] = GUICtrlCreateCombo("", 216, 80, 57 + 5, 25, BitOR($CBS_DROPDOWN,$CBS_AUTOHSCROLL))
		GUICtrlSetOnEvent(-1, "GUIBBCustomArmy")
		GUICtrlSetData(-1,  $g_sBBDropOrderDefault)
		GUICtrlSetState(-1, $GUI_DISABLE)
	$g_hComboTroopBB[4] = GUICtrlCreateCombo("", 280, 80, 57 + 5, 25, BitOR($CBS_DROPDOWN,$CBS_AUTOHSCROLL))
		GUICtrlSetOnEvent(-1, "GUIBBCustomArmy")
		GUICtrlSetData(-1,  $g_sBBDropOrderDefault)
		GUICtrlSetState(-1, $GUI_DISABLE)
	$g_hComboTroopBB[5] = GUICtrlCreateCombo("", 344, 80, 57 + 5, 25, BitOR($CBS_DROPDOWN,$CBS_AUTOHSCROLL))
		GUICtrlSetOnEvent(-1, "GUIBBCustomArmy")
		GUICtrlSetData(-1,  $g_sBBDropOrderDefault)
		GUICtrlSetState(-1, $GUI_DISABLE)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	...
	$g_hChkBBCustomDropOrderEnable = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "BBChkCustomDropOrderEnable", "Enable Custom Dropping Order"), 16, 136, 150, 17)
		GUICtrlSetState(-1, $GUI_UNCHECKED)
