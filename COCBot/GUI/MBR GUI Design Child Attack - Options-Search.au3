...
Func CreateAttackSearchOptionsSearch()
	...
	$g_hTxtSearchReduceCount = GUICtrlCreateInput("20", $x + 122, $y + 2, 38, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 3)
	...
	$g_hTxtSearchReduceByMin = GUICtrlCreateInput("40", $x + 122, $y + 2, 38, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 3)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hTxtSearchReduceGold = GUICtrlCreateInput("2000", $x + 120, $y, 38, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 5)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hTxtSearchReduceElixir = GUICtrlCreateInput("2000", $x + 120, $y, 38, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 5)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hTxtSearchReduceGoldPlusElixir = GUICtrlCreateInput("4000", $x + 120, $y, 38, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 5)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hTxtSearchReduceDark = GUICtrlCreateInput("100", $x + 120, $y, 38, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 3)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hTxtSearchReduceTrophy = GUICtrlCreateInput("2", $x + 120, $y, 38, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 1)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hTxtSearchReduceShieldTrophy = GUICtrlCreateInput("2", $x + 120, $y, 38, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetLimit(-1, 1)
	_GUICtrlCreateIcon($g_sLibIconPath, $eIcnTrophy, $x + 165, $y, 16, 16)
	_GUICtrlSetTip(-1, $sTxtTip)
	...
	$g_hTxtReturnTimer = GUICtrlCreateInput("5", $x + 15, $y + 15, 25, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	GUICtrlSetLimit(-1, 3)
