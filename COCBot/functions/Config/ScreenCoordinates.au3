...
Global $aiClickAwayRegionLeft = [115, 55, 156, 65] ; Custom fix - Team AIO Mod++
...
Global $aReloadButton[2][4] = [[190, 382 + $g_iMidOffsetY, 0x80CAC3, 10], [443, 408 + $g_iMidOffsetY, 0x282828, 10]] ; Reload Coc Button after Out of Sync, 860x780, [0] is the new UI (Small Reload button on Left)
...
Global $aCancRequestCCBtn[4] = [333, 355, 0xD84D1E, 20] ; Orange button Cancel in window request CC
Global $aSendRequestCCBtn[3] = [518, 352, 0x6EBD1F] ; Green button Send in window request CC
